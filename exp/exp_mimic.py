...
class Exp_Standard(Exp_Basic):
    ...
    def _get_data_loader(self,dataset,subsampler = None,shuffle = False):   
        ...
        if 'seft' in self.args.model:
        ...
        elif 'hier' in self.args.model or 'raindrop' in self.args.model or 'warp' in self.args.model or 'vmt' in self.args.model:
            data_min,data_max = None,None
        else:
            ...
            #data_min,data_max = None,None
        print(self.args.model, data_min,data_max)
        ...
        with torch.no_grad():
            for i, item in enumerate(test_loader):
                ...
                if self.args.use_amp:
                    ...
                    outputs,att,inp = self.model(item,test_mean)
